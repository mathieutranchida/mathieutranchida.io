  ...
  return (
    <>
      <Wrapper>
        ...
        <Paragraph>
          Partially functionning twitter clone with a functionning feed,
          profile, post, like, and repost features.
        </Paragraph>
        <Paragraph>
          This was a project for my diploma at Concordia Bootcamps.
        </Paragraph>
        <Paragraph>
          <ParagraphStrong>Technologies used:</ParagraphStrong> React, Redux,
